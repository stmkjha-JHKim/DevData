  ...
  // Status / Machine / Program filter (select boxes) + SID search (text
  // input) for the current session list - filters instantly on the client
  ...
  const filterSidInput = document.getElementById('filterSid');
  ...
  filterSidInput.addEventListener('input', applySessionFilters);
  filterResetBtn.addEventListener('click', () => {
    filterStatusSelect.value = '';
    filterMachineSelect.value = '';
    filterProgramSelect.value = '';
    filterSidInput.value = '';
    applySessionFilters();
  });
